...
class PeepSoModalComments implements PeepSoAjaxCallback
{
	...
	public function get_object(PeepSoAjaxResponse $resp)
	{
		...
		if (is_null($act_external_id) || is_null($type)) {
			...
			add_filter('peeps_activity_post_actions', array(&$this, 'add_post_actions'));
			...
			remove_filter('peeps_activity_post_actions', array(&$this, 'add_post_actions'));
	 ...
	 * @return  array
	 */
	public function add_post_actions($actions)
	{
		global $post;
