...
//	const STATUS_SENT = 4;					// TODO: not used yet
	 ...
	 */
	public static function add_message($user_id, $data, $subject, $template, $type, $module = 0, $now = 0)
	{
	...
	public static function process_mailqueue($now = 0)
	{
		...
		$queue = self::get_by_status($status, PeepSo::get_option('site_emails_process_count', 25));
