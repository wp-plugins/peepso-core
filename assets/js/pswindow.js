...
PsWindow.prototype.acknowledge = function(message, title)
{
	...
	if ("undefined" === typeof(title))
		title = jQuery("#default-acknowledge-dialog #default-acknowledge-title").html();

	var content = jQuery("#default-acknowledge-dialog #default-acknowledge-content").html();
	content = content.replace("{content}", message);
	var actions = jQuery("#default-acknowledge-dialog #default-acknowledge-actions").html();
